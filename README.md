...
| ----------- | ----------- | ----------- | 
| 1 пара 26.06 | — | Введение в Python, переменные. | 
| 2 пара 26.06 | — | f-строки, конструкции с if-elif-else, цикл for. | 
| __Задание__ | — | __Доделать задания, которые начали на парах.__ | 
| 3 пара 26.06 | — | Продолжение цикла for, цикл while, списки. | 
| 1 пара 27.06 | — | Словари и функции. | 
| 2 пара 27.06 | — | Работа с файлами на примере анализа генома бактерии _Escherichia coli._ | 
| __Задание__ | — | __Анализ геномных последовательностей.__ | 
| 3 пара 27.06 | — | Модуль random. Обсуждение и вопросы по анализу собственных геномов. | 
