...
| ----------- | ----------- | ----------- | 
| 3 пара 24.06 | — | Введение в Python, переменные. | 
| 1 пара 26.06 | — | f-строки, конструкции с if-elif-else, цикл for. | 
| 2 пара 26.06 | — | Продолжение цикла for, цикл while, списки. | 
| __Задание__ | — | __Доделать задания, которые начали на парах.__ | 
| 3 пара 26.06 | — | Словари и функции. | 
| 1 пара 27.06 | — | Работа с файлами на примере анализа генома бактерии _Escherichia coli._ | 
| 2 пара 27.06 | — | Модуль random на примере анализа генома _Arabidopsis thaliana_ и табака. | 
| __Задание__ | — | __Анализ геномных последовательностей.__ | 
| 3 пара 27.06 | — | Модули matpoltlib и seaborn для построения графиков, задания по геному архей. | 

Геномы своих организмов можно найти [по ссылке](https://disk.yandex.ru/d/SQdXhqe6OiFxmg), файлы подписаны вашими именами, выполнять второе задание задание нужно именно на их основе. Вопросы по заданию, курсу или Python в целом можно и нужно задавать либо по почте (nachatoi@fbb.msu.ru), либо в [telegram](https://t.me/Subpolare). Туда же до 1:00 28 июня нужно отправить результат основного задания, оформленный в свободном стиле. 
